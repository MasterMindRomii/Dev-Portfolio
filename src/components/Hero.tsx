  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-br from-[#222829] via-[#2a2f32] to-[#1a1f23]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center font-poppins z-20 px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 animate-fade-in-up animation-delay-300 relative z-30">
          <a href="https://github.com/MasterMindRomii" target="_blank" rel="noopener noreferrer"
             className="group bg-[#49c5b6]/10 hover:bg-[#49c5b6]/20 border border-[#49c5b6]/30 hover:border-[#49c5b6]/50 rounded-lg px-6 py-3 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer">
          ...
          <a href="#projects" 
             className="group bg-gradient-to-r from-[#49c5b6]/10 to-[#49c5b6]/5 hover:from-[#49c5b6]/20 hover:to-[#49c5b6]/15 border border-[#49c5b6]/30 hover:border-[#49c5b6]/50 rounded-lg px-6 py-3 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer">
            <div className="flex items-center justify-center gap-2">
        ...
        {/* Coding Platform Links - Smaller, secondary */}
        <div className="flex flex-wrap justify-center gap-3 mb-6 animate-fade-in-up animation-delay-400 relative z-30">
          <a href="https://www.kaggle.com/romiigupta/code" target="_blank" rel="noopener noreferrer"
             className="group bg-[#49c5b6]/5 hover:bg-[#49c5b6]/10 border border-[#49c5b6]/20 hover:border-[#49c5b6]/30 rounded-lg px-4 py-2 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-[#49c5b6]/80 group-hover:text-[#49c5b6] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-6.141 18.281c-.047.141-.164.234-.375.234-.328 0-.75-.234-.75-.234l-2.344-1.406-2.7 1.406s-.421.234-.75.234c-.211 0-.328-.094-.375-.234-.094-.375 0-.609.094-.75l1.406-2.7-1.406-2.7c-.094-.141-.188-.375-.094-.75.047-.141.164-.234.375-.234.328 0 .75.234.75.234l2.7 1.406 2.344-1.406s.421-.234.75-.234c.211 0 .328.094.375.234.094.375 0 .609-.094.75l-1.406 2.7 1.406 2.7c.094.141.188.375.094.75z"/>
              </svg>
              <span className="text-[#49c5b6]/80 group-hover:text-[#49c5b6] font-medium text-sm transition-colors">Kaggle</span>
            </div>
          </a>
          ...
          <a href="https://platform.stratascratch.com/user/MasterMindRomi" target="_blank" rel="noopener noreferrer"
             className="group bg-[#49c5b6]/5 hover:bg-[#49c5b6]/10 border border-[#49c5b6]/20 hover:border-[#49c5b6]/30 rounded-lg px-4 py-2 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-[#49c5b6]/80 group-hover:text-[#49c5b6] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
              </svg>
              <span className="text-[#49c5b6]/80 group-hover:text-[#49c5b6] font-medium text-sm transition-colors">StrataScratch</span>
            </div>
          </a>

          <a href="https://leetcode.com/u/RomiGuptaCS/" target="_blank" rel="noopener noreferrer"
             className="group bg-[#49c5b6]/5 hover:bg-[#49c5b6]/10 border border-[#49c5b6]/20 hover:border-[#49c5b6]/30 rounded-lg px-4 py-2 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer relative">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-[#49c5b6]/80 group-hover:text-[#49c5b6] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-[#49c5b6]/80 group-hover:text-[#49c5b6] font-medium text-sm transition-colors">LeetCode</span>
              <span className="absolute -top-1 -right-1 bg-gradient-to-r from-yellow-400 to-orange-400 text-black text-xs font-bold px-1.5 py-0.5 rounded-full">
                1%
              </span>
            </div>
          </a>
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 lg:hidden max-w-sm md:max-w-lg animate-fade-in-up animation-delay-500">
